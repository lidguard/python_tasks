...
#create function to calculate adjacent mines
def mines(input_grid):
    grid_len = len(input_grid)
    solution_grid = []

    #create empty lists to append bombs and numbers
...
if __name__ == '__main__':
    ...
    #print both input and solution grids to check calculations are correct
    #format to print as grids
    print("Input grid:")
